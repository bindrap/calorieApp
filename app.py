...
import os
database_path = os.environ.get('DATABASE_PATH', 'data/calorie_tracker.db')
...
def calculate_today_stats(user_id):
    """Calculate today's nutrition stats for a user"""
...
def upload_food():
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            # Store the initial entry (user can edit later)
            ...
            analysis_data = {
                ...
                'fallback_reasoning': calorie_result.get('fallback_reasoning', ''),
                'final_food_name': recognition_result['primary_food'],
                'final_weight_grams': recognition_result.get('estimated_weight', 0),
                'final_calories': calorie_result['total_calories'],
                'final_protein': calorie_result.get('protein', 0),
                'final_carbs': calorie_result.get('carbs', 0),
                'final_fat': calorie_result.get('fat', 0),
